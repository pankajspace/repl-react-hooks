...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  const useFetch = (url) => {
    const isCurrent = react2.useRef(true);
    const [state, setState] = react2.useState({data: [], loading: true});
    react2.useEffect(() => {
      return () => {
    ...
    react2.useEffect(() => {
      setState((state2) => ({data: state2.data, loading: true}));
  ...
  const UseMemoApp1 = () => {
    ...
    const longestWord = react2.useMemo(() => getLongestWord(data), [data]);
    return react2.default.createElement(react2.default.Fragment, null, react2.default.createElement("div", null, "Count: ", count), react2.default.createElement("button", {
      onClick: () => setCount((c) => c + 1)
    }, "Increment"), react2.default.createElement("div", null, "Longest word: ", longestWord));
  };

  // src/App.js
  const react = __toModule(require_react());
  const react_dom = __toModule(require_react_dom());
  react_dom.default.render(react.default.createElement("div", {
    className: "App"
  }, react.default.createElement(UseMemoApp1, null)), document.getElementById("root"));
})();
